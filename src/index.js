// const for projects
const listsContainer = document.querySelector("[data-lists]"); //ok
const newListForm = document.querySelector("[data-new-list-form]"); //ok
const newListInput = document.querySelector("[data-new-list-input]"); //ok
const deleteListButton = document.querySelector("[data-delete-list-button]"); //ok
const listDisplayContainer = document.querySelector("[data-list-display-container]"); //ok
const listTitleElement = document.querySelector("[data-list-title"); //ok
const listCountElement = document.querySelector("[data-list-count"); //ok
// end of the const for projects
